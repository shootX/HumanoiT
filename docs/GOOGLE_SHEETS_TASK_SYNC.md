...
| მაღაზია    | Title / სათაური | Description | Priority | Due Date | Humana Tasks ID |
|------------|-----------------|-------------|----------|----------|-----------|
...
- **Humana Tasks ID** – არასავალდებულო; თუ არის, ტასკი განახლდება.

პროექტები Humana Tasks-ში უნდა იყოს სახელებით მაგ. „ვარკეთილის ფილიალი“, „დიღომის ფილიალი“ (ან სახელში შესაბამისი მაღაზიის სახელი).
...
- **workspace_id** – Humana Tasks-ში workspace-ის ID; პროექტი ყოველ რიგზე განისაზღვრება სვეტით „მაღაზია“.
