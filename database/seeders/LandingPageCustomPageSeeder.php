    ...
    public function run(): void
    {
        $pages = [
            [
                ...
                'meta_title' => 'About Humana Tasks - Project Management & Team Collaboration Platform',
                'meta_description' => 'Learn about Humana Tasks, the comprehensive project management platform with task management, time tracking, budgeting, and team collaboration features.',
                'is_active' => true,
                'sort_order' => 1
            ],
            [
