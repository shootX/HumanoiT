...
export function Tokyo({ invoice, color, showQr, invoiceUrl, footerTitle, footerNotes, remainingAmount, formatAmount, t }: any) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-8" style={{ fontFamily: 'serif' }}>
      <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-lg overflow-hidden">
        <div className="p-8 space-y-8">
          <div className="pb-8 text-right" style={{ borderBottom: `3px solid ${template.primary}` }}>
