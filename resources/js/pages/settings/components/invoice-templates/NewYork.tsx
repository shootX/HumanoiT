...
export function NewYork({ invoice, color, showQr, invoiceUrl, footerTitle, footerNotes, remainingAmount, formatAmount, t }: any) {
          ...
          <div className="pb-8" style={{ borderBottom: `3px solid ${template.primary}` }}>
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
              <div className="lg:col-span-1">
                ...
                <div className="text-sm space-y-1"><p>{invoiceData.invoice_number}</p></div>
              </div>
