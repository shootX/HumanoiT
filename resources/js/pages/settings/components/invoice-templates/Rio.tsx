...
export function Rio({ invoice, color, showQr, invoiceUrl, footerTitle, footerNotes, remainingAmount, formatAmount, t }: any) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-8" style={{ fontFamily: 'monospace' }}>
