...
export function Toronto({ invoice, color, showQr, invoiceUrl, footerTitle, footerNotes, remainingAmount, formatAmount, t }: any) {
        ...
        <div className="p-8 space-y-8">
          ...
          <div className="space-y-6">
            ...
            <div className="text-left">
              ...
              <div className="p-4 rounded ml-4" style={{ backgroundColor: `${template.primary}10` }}>
