...
export function Istanbul({ invoice, color, showQr, invoiceUrl, footerTitle, footerNotes, remainingAmount, formatAmount, t }: any) {
    ...
    <div className="min-h-screen bg-gray-50 p-8">
      <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-lg overflow-hidden">
        <div className="p-8 space-y-8">
          <div className="pb-8 text-center" style={{ backgroundColor: `${template.primary}10`, borderBottom: `3px solid ${template.primary}` }}>
            ...
            <div className="flex justify-center gap-12 mt-6">
              <div>
                <div className="space-y-1 text-left">
                  ...
                  <div className="p-1 rounded" style={{ backgroundColor: `${template.primary}08` }}><div className="text-xs text-gray-500">{translate('Invoice Date')}</div><div className="font-semibold">{new Date(invoiceData.invoice_date).toLocaleDateString()}</div></div>
                  <div className="p-1 rounded" style={{ backgroundColor: `${template.primary}08` }}><div className="text-xs text-gray-500">{translate('Due Date')}</div><div className="font-semibold">{new Date(invoiceData.due_date).toLocaleDateString()}</div></div>
                </div>
              </div>
            </div>
          </div>
