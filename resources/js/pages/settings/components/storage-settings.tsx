...
'webp': 'webp'
  ...
  useEffect(() => {
    ...
    setStorageSettings(prev => ({
      ...prev,
      storageType: (settings.storage_type as StorageType) ?? prev.storageType,
      allowedFileTypes: settings.storage_file_types ?? prev.allowedFileTypes,
      maxUploadSize: settings.storage_max_upload_size ?? prev.maxUploadSize,
      awsAccessKeyId: settings.aws_access_key_id ?? prev.awsAccessKeyId,
      awsSecretAccessKey: settings.aws_secret_access_key ?? prev.awsSecretAccessKey,
      awsDefaultRegion: settings.aws_default_region ?? prev.awsDefaultRegion,
      awsBucket: settings.aws_bucket ?? prev.awsBucket,
      awsUrl: settings.aws_url ?? prev.awsUrl,
      awsEndpoint: settings.aws_endpoint ?? prev.awsEndpoint,
      wasabiAccessKey: settings.wasabi_access_key ?? prev.wasabiAccessKey,
      wasabiSecretKey: settings.wasabi_secret_key ?? prev.wasabiSecretKey,
      wasabiRegion: settings.wasabi_region ?? prev.wasabiRegion,
      wasabiBucket: settings.wasabi_bucket ?? prev.wasabiBucket,
      wasabiUrl: settings.wasabi_url ?? prev.wasabiUrl,
      wasabiRoot: settings.wasabi_root ?? prev.wasabiRoot,
    }));
  }, [settings]);
