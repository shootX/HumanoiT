...
import { Copy, Check, Users, DollarSign, TrendingUp, Award, Clock } from 'lucide-react';
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <h3 className="mt-2 text-2xl font-bold">{currencySymbol}{(stats.availableBalance || 0).toFixed(2)}</h3>
              </div>
