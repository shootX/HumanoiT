...
export default function MediaLibraryModal({ 
  ...
  const canCreateMedia = hasPermission(permissions, 'media_upload') || hasPermission(permissions, 'media_create');
  const canManageMedia = hasPermission(permissions, 'manage-any-media') || hasPermission(permissions, 'media_manage');
