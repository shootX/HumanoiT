    ...
    */
    function _paymentResponse($result){
        ...
        if ($result->status === 1) {
            ...
            $allowedDomains = ['easebuzz.in', 'pay.easebuzz.in', 'testpay.easebuzz.in', 'devpay.easebuzz.in'];
            if ($redirectUrl && \App\Helpers\UrlSecurity::isSafeRedirectUrl($redirectUrl, $allowedDomains)) {
