...
- **დავალებების იმპორტი ტექსტიდან (Tasks → Paste Import)**  
  - მრავალი დავალების შექმნა ერთი ტექსტის ჩასმით: პირველი ხაზი ფილიალი, შემდეგ დავალებების სია.  
  - დეტალური ჩანაწერი: `CHANGELOG-crm.inexia.cc.md` (v1.6.0).
